...
public class ChildActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intentFromChildAcitivity = getIntent();

        // TODO (4) Create an if statement to check if this Intent has the extra we passed from MainActivity
        if (intentFromChildAcitivity.hasExtra(Intent.EXTRA_TEXT)) {

            String displayText = intentFromChildAcitivity.getStringExtra(Intent.EXTRA_TEXT);

...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        long allMinutesUntilBoarding = info.getMinutesUntilBoarding();
        long hoursUntilBoarding = TimeUnit.MINUTES.toHours(allMinutesUntilBoarding);
        long minutesUntilBoarding = allMinutesUntilBoarding -
                TimeUnit.HOURS.toMinutes(hoursUntilBoarding);
        String timeUntilBoarding = getResources().getString(
